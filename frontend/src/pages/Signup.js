...
function Signup() {
    ...
    async function uploadImage(){
        ...
        data.append('upload_preset', 'rb5hdhsn');
        try{
            setUploadingImg(true);
            let res = await fetch('https://api.cloudinary.com/v1_1/vishals770/image/upload',{
                method: 'post',
                body: data,
            });
    ...
    return (
        <Container>
            <Row>
                <Col md={7} className="d-flex align-items-center justify-content-center flex-directon-column">
